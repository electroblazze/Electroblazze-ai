      ...
      <div className="space-y-4 max-w-3xl mx-auto pb-20">
        ...
        {showWelcome && (
          <motion.div 
            ...
            className="bg-gradient-to-br from-white/80 to-white/50 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-white/20 my-8"
          >
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary animate-gradient">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {CHAT_SUGGESTIONS.map((suggestion, index) => (
                  <Button
                    key={index}
                    variant="outline"
                    className="p-4 h-auto flex items-start text-left bg-white/80 hover:bg-white hover:shadow-md transition-all border border-gray-200 group"
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-500 mt-1 line-clamp-2">{suggestion.prompt}</p>
                    </div>
                    <ArrowRight className="h-4 w-4 text-gray-400 opacity-0 group-hover:opacity-100 transition-opacity ml-2 mt-1" />
                  </Button>
                ))}
              </div>
            </div>
